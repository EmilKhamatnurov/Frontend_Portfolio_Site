...
const BURGER_BUTTON_CLASS_ANIMATION = 'button_animation';
...
const burgerLinesNode = document.querySelector('.burger-btn-lines');
...
function toggleBurger() {
	...
	burgerLinesNode.classList.toggle(BURGER_BUTTON_CLASS_ANIMATION)
	// Анимация бургера
